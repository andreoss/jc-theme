...
(defcustom jc-red-color "#AE0033"
  "Red color."
  :group 'jc-theme
  :type  'color)

(defcustom jc-yellow-color "#DFDA00"
  "Red color."
  :group 'jc-theme
  :type  'color)

(defcustom jc-blue-color "#0047AE"
  "Red color."
  :group 'jc-theme
  :type  'color)

(defcustom jc-green-color "#00AE47"
  "Red color."
  :group 'jc-theme
  :type  'color)

(defcustom jc-foreground-color (jc-color-inverse jc-background-color)
  "Foreground color."
  :group 'jc-theme
  :type  'color)
...
(defun jc--init (name filters)
  ...
  (let* ((f  (jc--combine (cons 'jc-color-identity filters)) )
         ...
         (m  (jc-color-shade bg))
         ;; Shade
         (shade-1 (funcall f (jc-color-shade jc-background-color 0.95)))
         (shade-2 (funcall f (jc-color-shade jc-background-color 0.90)))
         (shade-3 (funcall f (jc-color-shade jc-background-color 0.85)))
         (shade-4 (funcall f (jc-color-shade jc-background-color 0.80)))
         (shade-5 (funcall f (jc-color-shade jc-background-color 0.75)))
         (shade-6 (funcall f (jc-color-shade jc-background-color 0.75)))
